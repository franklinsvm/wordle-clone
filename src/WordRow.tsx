...
function CharacterBox({ value, state }: CharacterBoxProps) {
  ...
  return (
    <span
      className={`border-2 p-2 flex justify-center items-center min-w-full uppercase text-center font-extrabold text-4xl before:inline-block before:content-['_'] ${stateStyles} `}
    >
      {value}
    </span>
  );
